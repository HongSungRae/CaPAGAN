...
def cp(image_source, image_target, mask_source, mask_target, imsize):
    '''
    ...
    imsize : int. rescale image size. i.e. h'=w'=imsize
    ...
    inpatined_target = cv2.inpaint(image_target, mask_target[...,None], 3, cv2.INPAINT_TELEA)
...
def get_warp_points(imsize):
    ...
    = return =
    _from : circle centeroid coordinates : list
    _to : Gaussian moved point coordinates : list
    '''
    # init variables
    _from = []
    _to = []
